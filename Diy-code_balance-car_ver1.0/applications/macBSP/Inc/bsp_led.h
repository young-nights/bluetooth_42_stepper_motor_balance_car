...
#define             LED_NUM             (2)
/****************************** LED 函数宏定义***************************************/
#define             macLED_1_OFF()                        HAL_GPIO_WritePin ( LED1_GPIO_Port, LED1_Pin , GPIO_PIN_RESET )
#define             macLED_1_ON()                         HAL_GPIO_WritePin ( LED1_GPIO_Port, LED1_Pin , GPIO_PIN_SET )

#define             macLED_2_OFF()                        HAL_GPIO_WritePin ( LED2_GPIO_Port, LED2_Pin , GPIO_PIN_RESET)
#define             macLED_2_ON()                         HAL_GPIO_WritePin ( LED2_GPIO_Port, LED2_Pin , GPIO_PIN_SET )
